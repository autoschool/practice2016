...
public class StationsScreen {
    public StationsScreen(RemoteWebDriver driver){
        PageFactory.initElements(new HtmlElementDecorator(new HtmlElementLocatorFactory(driver)), this);
    }

    @Name("Поле ввода названия станции")
    @FindBy(id = "ru.yandex.metro:id/filterTextId")
    private HtmlElement stationNameInputField;

    @Name("Список станций")
    @FindBy(id="ru.yandex.metro:id/txtStationName")
    private List<HtmlElement> stationsList;

    public HtmlElement getStationNameInputField() {
        return stationNameInputField;
    }
